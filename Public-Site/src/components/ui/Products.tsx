          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
            {otherProducts.map((product, index) => (
                ...
                >
                  {product.special ? (
                      <>
                        {/* Special Product Card (DAZEL Naturals) */}
                        <div className="aspect-[4/3] bg-gradient-to-br from-purple-50 to-pink-50 overflow-hidden flex items-center justify-center relative">
                          <img
                              src={product.image}
                              alt={product.name}
                              className="w-full h-full object-cover"
                          ...
                          />
                          <div className="absolute inset-0 bg-gradient-to-br from-purple-100 to-pink-100 hidden items-center justify-center">
                            <product.icon size={64} className="text-purple-600" />
                          </div>
                        </div>
                        <div className="p-6">
                        ...
                        <div className={`${product.color} p-6 md:p-8 text-white relative overflow-hidden`}>
                          ...
                          <div className="flex flex-wrap gap-1.5 relative z-10">
                            {product.sizes.map(size => (
                                <span key={size} className="px-2 py-0.5 bg-white/20 rounded text-xs font-medium">
                          {size}
                        </span>
                            ))}
                          </div>
